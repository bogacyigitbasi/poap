...
fn contract_transfer<S: HasStateApi>(
    ...
    } in transfers
    {
        ...
        // Authenticate the sender for this transfer
            ...
            amount == 1.into(),
            ContractError::Custom(CustomContractError::MoreThanOneTokenTransfer)
        );
...
#[receive(contract = "poap", name = "onReceivingCIS2", error = "ContractError")]
